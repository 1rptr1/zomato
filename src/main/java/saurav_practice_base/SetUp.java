...
public class SetUp {
	...
	public void adb_kill_Emulator() throws InterruptedException, IOException
	{
		...
		String[] aCommand = new String[] { "C:\\Users\\RptR\\AppData\\Local\\Android\\Sdk\\platform-tools\\adb", "emu", "kill" };
	...
	public void adb_kill_app(String packagename) throws InterruptedException, IOException
	{
		...
		String[] aCommand = new String[] { "C:\\Users\\RptR\\AppData\\Local\\Android\\Sdk\\platform-tools\\adb", "uninstall", "packagename" };
		Process  process = new ProcessBuilder(aCommand).start();
		process.waitFor(1, TimeUnit.SECONDS);
